            ...
            child: Container(
              ...
              child: InnerShadow(
                ...
                child: Container(
                  ...
                  child: Text("But unlike the usual you are the one who decides the menu of the week" ,
                  ...
                  onPressed: () {
                    Navigator.of(context).pushReplacement(
                      createCircleTransition(
                        context: context,
                        page: ThirdPage(), // You'll need to import or create this
                ...
                IconButton(
                  onPressed: () {
                    Navigator.of(context).pushReplacement(
                      createCircleTransition(
                        context: context,
                        page: FifthPage(), // You'll need to create this
